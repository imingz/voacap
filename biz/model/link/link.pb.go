...
var file_link_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x32, 0x91, 0x02, 0x0a, 0x0b, 0x4c, 0x69, 0x6e, 0x6b, 0x53,
	...
	0x74, 0x65, 0x4c, 0x69, 0x6e, 0x6b, 0x42, 0x79, 0x49, 0x64, 0x42, 0x17, 0x5a, 0x15, 0x76, 0x6f,
...
var file_link_proto_goTypes = []interface{}{
	...
	(*common.Link)(nil),                   // 6: common.Link
	(*common.SysConfig)(nil),              // 7: common.SysConfig
	(*common.InterferOrTransStation)(nil), // 8: common.InterferOrTransStation
	(*common.RecvStation)(nil),            // 9: common.RecvStation
}
var file_link_proto_depIdxs = []int32{
	6, // 0: link.getLinksResponse.data:type_name -> common.Link
	7, // 1: link.addLinkRequest.sysConfig:type_name -> common.SysConfig
	8, // 2: link.addLinkRequest.transStation:type_name -> common.InterferOrTransStation
	9, // 3: link.addLinkRequest.recvStation:type_name -> common.RecvStation
	8, // 4: link.addLinkRequest.interferStation:type_name -> common.InterferOrTransStation
	...
	1, // 8: link.LinkService.GetLinks:output_type -> link.getLinksResponse
	3, // 9: link.LinkService.AddLink:output_type -> link.addLinkResponse
	5, // 10: link.LinkService.updateLinkById:output_type -> link.updateLinkByIdResponse
